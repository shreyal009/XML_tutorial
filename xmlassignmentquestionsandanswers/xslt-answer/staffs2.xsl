...
<tr>
<td colspan="1">Staff Count:<xsl:value-of select="count(Staffs/EMPLOYEE[GENDER='FEMALE'])"/></td>
<td colspan="2">Total Salary:<xsl:value-of select="sum(Staffs/EMPLOYEE[GENDER='FEMALE']/SALARY)"/></td>
</tr>
</table>
</body>
</html>
